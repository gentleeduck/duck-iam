...
### [@duck-gen](https://github.com/gentleeduck/duck-gen)
**Type-Safe Generation + Developer Tooling**

A type-safe toolkit built for API/message generation and modern TypeScript workflows. duck-gen delivers:
