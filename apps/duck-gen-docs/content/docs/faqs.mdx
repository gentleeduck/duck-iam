...
https://github.com/gentleeduck/duck-gen
...
<Accordion type="multiple" collapsible className="w-full">
  ...
  <AccordionItem value="install-run">
    ...
    <AccordionContent className="text-muted-foreground">
      ...
      <div className="mt-3">
        <code className="rounded bg-muted px-2 py-1">bun add -d @gentleduck/gen</code>
      </div>
      <div className="mt-3">
        <code className="rounded bg-muted px-2 py-1">bunx duck-gen</code>
      </div>
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="troubleshooting">
    ...
    <AccordionContent className="text-muted-foreground">
      ...
      <div className="mt-3">
        <code className="rounded bg-muted px-2 py-1">https://github.com/gentleeduck/duck-gen</code>
      </div>
    </AccordionContent>
  </AccordionItem>
</Accordion>
