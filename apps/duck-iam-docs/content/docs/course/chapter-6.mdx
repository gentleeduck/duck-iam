...
```typescript
import { extractEnvironment } from 'duck-iam/server/generic'
...
```typescript
import { createSubjectCan } from 'duck-iam/server/generic'
...
<Steps>
  <Step>
    **Global middleware**
    ...
    import { accessMiddleware } from 'duck-iam/server/express'
  ...
  <Step>
    **Per-route guards**
    ...
    ```typescript title="src/server.ts"
    import { guard } from 'duck-iam/server/express'
  ...
  <Step>
    **Admin router**
    ...
    import { adminRouter } from 'duck-iam/server/express'
...
<Steps>
  <Step>
    **Global middleware**
    ...
    import { engine } from './access'
    import { accessMiddleware } from 'duck-iam/server/hono'
  ...
  <Step>
    **Per-route guards**
    ...
    ```typescript title="src/server.ts"
    import { guard } from 'duck-iam/server/hono'
...
<Steps>
  <Step>
    **Create the access module**
    ...
    import { createEngineProvider, ACCESS_ENGINE_TOKEN } from 'duck-iam/server/nest'
    import { engine } from './access'
  ...
  <Step>
    **Create the access guard**
    ...
    import { nestAccessGuard, ACCESS_ENGINE_TOKEN } from 'duck-iam/server/nest'
  ...
  <Step>
    **Use the @Authorize decorator**
    ...
    import { Authorize } from 'duck-iam/server/nest'
...
<Steps>
  ...
  <Step>
    **Check permissions in Server Components**
    ...
    import { checkAccess, getPermissions } from 'duck-iam/server/next'
    import { engine } from '@/lib/access'
  ...
  <Step>
    **Next.js middleware for route-level protection**
    ...
    import { createNextMiddleware } from 'duck-iam/server/next'
    import { engine } from '@/lib/access'
