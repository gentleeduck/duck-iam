...
<Accordion type="multiple" collapsible className="w-full">
  <AccordionItem value="explain-hooks">
    ...
    <AccordionContent className="text-muted-foreground">
      Explain mode is intentionally read-only. It applies <code className="rounded bg-muted px-2 py-1">beforeEvaluate</code>
      ...
      or <code className="rounded bg-muted px-2 py-1">onError</code>.
    </AccordionContent>
  </AccordionItem>
