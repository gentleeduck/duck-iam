...
<Accordion type="multiple" collapsible className="w-full">
  ...
  <AccordionItem value="explain-prod-usage">
    ...
    <AccordionContent className="text-muted-foreground">
      Yes, but treat it as a debugging tool. It evaluates the real request path and returns rich traces, which is great for
      audits and support cases, but you should still control who can access those traces because they may expose policy and
      condition details.
    </AccordionContent>
  </AccordionItem>
</Accordion>
