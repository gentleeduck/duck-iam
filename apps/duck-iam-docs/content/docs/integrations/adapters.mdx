...
implement the full HTTP adapter contract by itself. If you want to use `HttpAdapter`,
either implement the complete endpoint set manually or extend the admin router with the
missing item lookups, scoped-role reads, and subject-attribute endpoints.
...
When this method is absent, the engine simply treats scoped assignments as empty and
continues with global role evaluation only.
...
<Accordion type="multiple" collapsible className="w-full">
  <AccordionItem value="adapter-responsibility">
    ...
    <AccordionContent className="text-muted-foreground">
      ...
      and subject attributes. The engine still owns evaluation, policy combination, explain traces, and decision logic.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="unscoped-first">
    ...
    <AccordionContent className="text-muted-foreground">
      ...
      support the core engine. Later, add that method and scoped assignment storage once your application actually needs
