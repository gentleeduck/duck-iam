...
const CONTENT_DIR_ENV_VAR = 'DUCK_IAM_DOCS_CONTENT_DIR'
...
const CATEGORY_ENUM = z.enum(['advanced', 'core', 'course', 'guides', 'installation', 'integrations', 'general', 'all'])
...
export function createMcpServer(): McpServer {
  const server = new McpServer(
    ...
    },
    {
      ...
      instructions: [
        'MCP server for @gentleduck/iam documentation (iam.gentleduck.org).',
